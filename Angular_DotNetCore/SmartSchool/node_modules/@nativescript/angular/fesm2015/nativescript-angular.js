...
const ɵ0$4 = replaceNgAttribute;
const ɵ1$1 = function addScopedStyleToCss(style) {
    Application.addCss(style, true);
};
const addScopedStyleToCss = profile(`"renderer".addScopedStyleToCss`, ɵ1$1);
