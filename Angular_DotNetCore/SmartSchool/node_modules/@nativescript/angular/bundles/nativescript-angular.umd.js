(function (global, factory) {
    ...
    exports.NativeScriptDebug = void 0;
    ...
    ***************************************************************************** */
    ...
    NSLocationStrategy.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NSLocationStrategy_Factory() { return new NSLocationStrategy(i0__namespace.ɵɵinject(FrameService)); }, token: NSLocationStrategy, providedIn: "root" });
    ...
    var ɵ1$3 = function (parent, child, next) {
    ...
    var ɵ0$5 = function (parent, child, next) {
        if (isInvisibleNode(child)) {
            return;
        }
    ...
    var ɵ0$4 = replaceNgAttribute;
    var ɵ1$1 = function addScopedStyleToCss(style) {
        core.Application.addCss(style, true);
    };
    var addScopedStyleToCss = core.profile("\"renderer\".addScopedStyleToCss", ɵ1$1);
    ...
    var NSRouterLinkActive = /** @class */ (function () {
        function NSRouterLinkActive(router, element, renderer, cdr, link) {
            var _this = this;
            this.router = router;
            this.element = element;
        ...
        NSRouterLinkActive.prototype.ngAfterContentInit = function () {
            ...
            rxjs.from([this.links.changes, rxjs.of(null)])
        ...
        NSRouterLinkActive.prototype.subscribeToEachLinkOnChanges = function () {
            var _this = this;
            var _a;
            (_a = this.linkInputChangesSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
            var allLinkChanges = __spread(this.links.toArray(), [this.link]).filter(function (link) { return !!link; }).map(function (link) { return link.onChanges; });
            this.linkInputChangesSubscription = rxjs.from(allLinkChanges)
                .pipe(operators.mergeAll())
        ...
        NSRouterLinkActive.prototype.update = function () {
            ...
            Promise.resolve().then(function () {
                ...
                if (_this.active !== hasActiveLinks) {
                    ...
                    var links = _this.link ? __spread(_this.links.toArray(), [_this.link]) : _this.links;
                    var isActiveLinks_1 = _this.reduceList(currentUrlTree, links);
    ...
    NSRouterLinkActive.ctorParameters = function () { return [
        ...
        { type: i0.Renderer2 },
        { type: i0.ChangeDetectorRef },
        { type: NSRouterLink, decorators: [{ type: i0.Optional }] }
    ]; };
    NSRouterLinkActive.propDecorators = {
        links: [{ type: i0.ContentChildren, args: [NSRouterLink, { descendants: true },] }],
